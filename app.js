...
let vocabPage=1,sentencePage=1,trilingualPage=1,lastVocabQuery="",lastSentencePageSize=40;
...
function home(){
  $("view").innerHTML=shell("English Master V7.0.1","Học • Luyện • Nhớ • Cải thiện",
...
function vocab(){
  ...
  if(q!==lastVocabQuery){vocabPage=1;lastVocabQuery=q;}
...
init();function sentences(){
  ...
  $("view").innerHTML=shell("Học câu","Hiển thị theo từng trang để app nhẹ hơn trên điện thoại.",
